...
<div class="row justify-content-center mt-3">
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        <a href="{{ route('condiciones-de-ventas.create') }}" class="btn btn-success btn-sm my-2"><i
            class="bi bi-plus-circle"></i> Agregar Forma de Venta</a>
        ...
        <tr>
          ...
          <form action="{{ route('condiciones-de-ventas.destroy', $condicion->id) }}" method="post">
            ...
            <a href="{{ route('condiciones-de-ventas.edit', $condicion->id) }}" class="btn btn-primary btn-sm"><i
              class="bi bi-pencil-square"></i> Editar</a>

            <button type="submit" class="btn btn-danger btn-sm"
            onclick="return confirm('¿Querés eliminar esta Forma de Venta? No hay vuelta atrás.');"><i
